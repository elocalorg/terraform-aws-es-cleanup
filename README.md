...
<p align="center">
  <img src="https://raw.githubusercontent.com/elocalorg/terraform-aws-es-cleanup/master/diagram.png">
</p>
...
| es\_endpoint | AWS ES FQDN e.g. search-es-demo-xxxxxxxxxx.us-east-1.es.amazonaws.com | `string` | n/a | yes |
...
module "public_es_cleanup" {
  source       = "elocalorg/es-cleanup/aws"
  version      = "1.0.0"
  prefix       = "public_es_"
  es_endpoint  = "test-es-XXXXXXX.us-east-1.es.amazonaws.com"
  delete_after = 365
}
...
module "vpc_es_cleanup" {
  ...
  version            = "1.0.0"
  prefix             = "vpc_es_"
  es_endpoint        = "vpc-gc-demo-vpc-gloo5rzcdhyiykwdlots2hdjla.us-east-1.es.amazonaws.com"
  index              = "all"
  delete_after       = 30
